...
/**
 * Container for the indices of the source <code>physiologicalActivities</code> from device <code>Fitbit</code>.

<pre>
source physiologicalActivities as PhysiologicalActivity [] indexed by period as Period;
</pre>
 */
public final class PhysiologicalActivitiesIndices implements Serializable {
    private static final long serialVersionUID = 0;
    
    public PhysiologicalActivitiesIndices(fr.inria.phoenix.diasuite.framework.datatype.period.Period period) {
        this._period = period;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        PhysiologicalActivitiesIndices other = (PhysiologicalActivitiesIndices) obj;
        if (_period == null) {
