...
/**
 * Container for the indices of the source <code>calories</code> from device <code>Fitbit</code>.
 * 
 * <pre>
 * source calories as Integer indexed by period as Period;
 * </pre>
 */
public final class CaloriesIndices implements Serializable {
    private static final long serialVersionUID = 0;
    
    public CaloriesIndices(fr.inria.phoenix.diasuite.framework.datatype.period.Period period) {
        this._period = period;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        CaloriesIndices other = (CaloriesIndices) obj;
        if (_period == null) {
