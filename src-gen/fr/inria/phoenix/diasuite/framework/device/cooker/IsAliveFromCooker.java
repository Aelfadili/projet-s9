...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>Cooker</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromCooker implements Serializable {
    ...
    public IsAliveFromCooker(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromCooker other = (IsAliveFromCooker) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>Cooker</code> device that published the source.
     * 
    ...
    public class CookerProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>Cooker</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>Cooker</code>.
         */
