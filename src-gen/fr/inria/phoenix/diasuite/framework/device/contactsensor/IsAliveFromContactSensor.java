...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>ContactSensor</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromContactSensor implements Serializable {
    ...
    public IsAliveFromContactSensor(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromContactSensor other = (IsAliveFromContactSensor) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>ContactSensor</code> device that published the source.
     * 
    ...
    public class ContactSensorProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>ContactSensor</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>ContactSensor</code>.
         */
