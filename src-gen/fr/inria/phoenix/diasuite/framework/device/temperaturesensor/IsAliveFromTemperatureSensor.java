...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>TemperatureSensor</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromTemperatureSensor implements Serializable {
    ...
    public IsAliveFromTemperatureSensor(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromTemperatureSensor other = (IsAliveFromTemperatureSensor) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>TemperatureSensor</code> device that published the source.
     * 
    ...
    public class TemperatureSensorProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>TemperatureSensor</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>TemperatureSensor</code>.
         */
