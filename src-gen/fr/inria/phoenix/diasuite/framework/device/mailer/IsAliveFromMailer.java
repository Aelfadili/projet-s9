...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>Mailer</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromMailer implements Serializable {
    ...
    public IsAliveFromMailer(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromMailer other = (IsAliveFromMailer) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>Mailer</code> device that published the source.
     * 
    ...
    public class MailerProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>Mailer</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>Mailer</code>.
         */
