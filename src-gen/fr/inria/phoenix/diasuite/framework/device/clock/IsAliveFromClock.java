...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>Clock</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromClock implements Serializable {
    ...
    public IsAliveFromClock(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromClock other = (IsAliveFromClock) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>Clock</code> device that published the source.
     * 
    ...
    public class ClockProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>Clock</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>Clock</code>.
         */
