...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>Android</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromAndroid implements Serializable {
    ...
    public IsAliveFromAndroid(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromAndroid other = (IsAliveFromAndroid) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>Android</code> device that published the source.
     * 
    ...
    public class AndroidProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>Android</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>Android</code>.
         */
