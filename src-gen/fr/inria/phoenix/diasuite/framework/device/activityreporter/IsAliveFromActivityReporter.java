...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>ActivityReporter</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromActivityReporter implements Serializable {
    ...
    public IsAliveFromActivityReporter(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromActivityReporter other = (IsAliveFromActivityReporter) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>ActivityReporter</code> device that published the source.
     * 
    ...
    public class ActivityReporterProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>ActivityReporter</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>ActivityReporter</code>.
         */
