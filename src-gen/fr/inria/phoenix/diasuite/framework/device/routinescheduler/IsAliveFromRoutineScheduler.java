...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>RoutineScheduler</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromRoutineScheduler implements Serializable {
    ...
    public IsAliveFromRoutineScheduler(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromRoutineScheduler other = (IsAliveFromRoutineScheduler) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>RoutineScheduler</code> device that published the source.
     * 
    ...
    public class RoutineSchedulerProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>RoutineScheduler</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>RoutineScheduler</code>.
         */
