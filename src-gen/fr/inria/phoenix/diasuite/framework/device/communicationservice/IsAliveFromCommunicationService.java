...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>CommunicationService</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromCommunicationService implements Serializable {
    ...
    public IsAliveFromCommunicationService(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromCommunicationService other = (IsAliveFromCommunicationService) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>CommunicationService</code> device that published the source.
     * 
    ...
    public class CommunicationServiceProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>CommunicationService</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>CommunicationService</code>.
         */
