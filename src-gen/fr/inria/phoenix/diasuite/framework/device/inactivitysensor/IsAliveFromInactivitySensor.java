...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>InactivitySensor</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromInactivitySensor implements Serializable {
    ...
    public IsAliveFromInactivitySensor(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromInactivitySensor other = (IsAliveFromInactivitySensor) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>InactivitySensor</code> device that published the source.
     * 
    ...
    public class InactivitySensorProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>InactivitySensor</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>InactivitySensor</code>.
         */
